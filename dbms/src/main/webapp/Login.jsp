				...
				<div class="row">
					<div class="col-md-4">
						...
						<form action="LoginController" method="POST">
							...
							<button type="submit" class="glow-on-hover">Sign-in</button>
		
						</form>
						<br>
						<form action="views/RegisterUser.jsp" >
							<button type="submit" class="glow-on-hover">Register a New User</button>
						</form>
						<br>
						<form action="index.html" >
							<button type="submit" class="glow-on-hover">Go Back</button>
						</form>
					</div>
